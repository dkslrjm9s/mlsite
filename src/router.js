...
const routes = [
    ...
    },
    {
        path: '/paper',
        name: 'paper',
        component: () => import('./components/mySite/Paper.vue'),
        meta: {
            breadcrumb: [{ parent: 'Paper', label: 'Paper' }],
        },
    },
    {
        path: '/statistics',
        name: 'statistics',
        component: () => import('./components/mySite/Statistics.vue'),
        meta: {
            breadcrumb: [{ parent: 'Statistics', label: 'Statistics' }],
        },
    },
    {
        path: '/formlayout',
