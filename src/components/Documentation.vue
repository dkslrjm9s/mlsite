...
"npm run test:unit": Runs the tests.
                ...
                <p>Freya consists of 3 main parts; the application layout, layout resources and theme resources for PrimeVue components. <i>App.vue</i> inside app folder is the html
					template for the base layout, required resources for the layout are placed inside the <i>public/layout</i> folder and similarly theme resources are inside <i>public/theme</i> folder.</p>
        ...
        menu: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {label: "Widgets", icon:"pi pi-star", to:"/widgets"},
...
import './App.scss'; 	                            //your styles and overrides
				...
				<p>Freya provides 16 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your
					bundle that are located inside assets/theme folder such as theme/purple/theme-light.css.</p>
				...
				<ul>
					...
					<li>Create a folder named "mytheme" under <i>src/assets/sass/theme</i> folder.</li>
					<li>Create a file such as theme.scss under <i>src/assets/theme/mytheme</i> folder.</li>
...
@import '../../../src/assets/sass/theme/theme_light';
...
<pre v-code><code>
sass src/assets/sass/theme/mytheme/theme.scss:src/assets/sass/theme/mytheme/theme.css
...
@import '../../sass/layout/_layout_light';
				...
				<h5>src/assets/sass/variables/layout/_layout_common.scss</h5>
